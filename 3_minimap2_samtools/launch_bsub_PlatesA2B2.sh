...
head -n5 BWA{01,02,03,04,05,06,07,08,09,10}//loop_minimap2_only_20180216.bsub # check.  should be mnmploop10
ls
#
...
# head BWA{01,03,05,07,09,10}/loop_samtools_only_20180210.bsub # check.  should be mnmploop10
...
ls ~/greenland_2017/platesA2B2/platesA2B2_combined/BWA05/minimap2_outputs # should show first set of bam files
