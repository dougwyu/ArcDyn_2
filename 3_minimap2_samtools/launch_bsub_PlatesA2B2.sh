...
MINIMAP2_BSUB="loop_minimap2_only_20180218.bsub"; echo ${MINIMAP2_BSUB}
MINIMAP2_SH="_loop_minimap2_only_20180218.sh"; echo ${MINIMAP2_SH}
...
cd ~/greenland_2017/platesA2B2/platesA2B2_combined; ls
parallel "sed 's/mnmploop01/mnmploop{}/g' BWA{}/${MINIMAP2_BSUB} > BWA{}/${MINIMAP2_BSUB}_tmp" ::: 01 02 03 04 05 06 07 08 09 10
parallel "mv BWA{}/${MINIMAP2_BSUB}_tmp BWA{}/${MINIMAP2_BSUB}" ::: 01 02 03 04 05 06 07 08 09 10
head -n5 BWA{01,02,03,04,05,06,07,08,09,10}/loop_minimap2_only_20180218.bsub # check.  should be mnmploop10
     # check if i'm using mellanox-ib
tail -n2 BWA{01,02,03,04,05,06,07,08,09,10}/loop_minimap2_only_20180218.bsub # check.  should be mnmploop10
