...
# Usage: bash _loop_minimap2_only_20180218.sh
...
# SCRIPT OUTLINE:
     ...
     # move the outputs to minimap2_outputs_19posctrls
     # rm working folder
     # next folder
...
# set variables
INDEX=1
if [ ! -d minimap2_outputs_19posctrls ] # if directory minimap2_outputs_19posctrls does not exist.  this is within the HOMEFOLDER
then
	mkdir minimap2_outputs_19posctrls
fi
...
do
     ...
     mv ${sample}_F0x4_sorted.bam ../minimap2_outputs_19posctrls/
...
mv folderlist.txt minimap2_outputs_19posctrls/
