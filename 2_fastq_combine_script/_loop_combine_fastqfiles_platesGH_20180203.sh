...
# these are the two runs for platesGH (as of 20180203)
     # platesGH/PKG-ENQ-2379-Data_Transfer-PSEQ-1603
     # platesGH/PKG-ENQ-2379-Data_Transfer-PSEQ-1600
     # platesGH/PKG-ENQ-2379-Data_Transfer-PSEQ-1586-trimmed
...
# find all folders (-type d) starting with "Sample*". search one level down.  keep only unique values. N.B. must sort before uniq
     # PKG-\w+-\w+-\w+-\w+-\w+[-\w]* # matches these folder names. the [-\w]* is to optionally match -trimmed
          # PKG-ENQ-2379-Data_Transfer-PSEQ-1586-trimmed
          # PKG-ENQ-2379-Data_Transfer-PSEQ-1600
          # PKG-ENQ-2379-Data_Transfer-PSEQ-1603
     # also sed -E 's/trimmed//g' to remove 'trimmed' from the output
     # to hide this folder:  PKG-ENQ-2379-Data_Transfer-PSEQ-1586/, i have put the folder inside another folder:  do_not_combine/
# less well_list.txt
# wc -l well_list.txt
