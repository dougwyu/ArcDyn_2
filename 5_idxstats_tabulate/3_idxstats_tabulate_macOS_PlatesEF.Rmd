...
idxstatsgenomecovfolder <- paste0("outputs_PlatesEF_", samtoolsfilter, "_", samtoolsqual, "_minimap2_outputs_20181111")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups
...
idx_mitogenome_table <- idx %>% group_by(well) %>% distinct(mitogenome) %>% count() %>% arrange(desc(n)); View(idx_mitogenome_table) # should be 352 in all rows
...
# e.g. 30720 rows / 160 mitogenomes = 192 samples
```
...
idx_meta %>% distinct(mitogenome) %>% count()  # number of distinct values of mitogenome (incl 3 COI spikes):  352 (308 mitogenomes + 41 COI_cytb + 3 COI_spike)
...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_PlatesEF_20181111.RDS", compress = TRUE)
...
# write_tsv(mocks_idx_meta_genomecov, "mocks_idx_meta_genomecov_PlatesEF_20181111.txt") # so if i need to read in a file during debuggging, here it is
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesEF_20181111.txt") # so if i need to read in a file during debuggging, here it is.  This is the file that we use for HMSC analysis, long format
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesEF_20181111.txt")
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide_PlatesEF_20181111.txt")
...
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide, "mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide_PlatesEF_20181111.txt")
# # #
# write_tsv(mocks_idx_meta_genomecov_pct_coverage_wide, "mocks_idx_meta_genomecov_pct_coverage_wide_PlatesEF_20181111.txt")
# # #
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_wide, "mocks_idx_meta_genomecov_mapped_reads_wide_PlatesEF_20181111.txt")#
```
