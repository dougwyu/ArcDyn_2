...
# Usage: bash _loop_trimgalore_20180221.sh
...
# upload _loop_trimgalore_20180221.sh *into* folder that contains the sample folders that i want to map
...
# GNU PARALLEL version, since trim galore only uses one cpu per job
