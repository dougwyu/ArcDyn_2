...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_20180211.RDS", compress = TRUE)
# genomecoverages_summ <- readRDS("genomecoverages_summ_20180211.RDS")
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesAB_20180211.txt") # so if i need to read in a file during debuggging, here it is
# used for debugging, in case i screw up the dataset while writing code
# idx_meta_genomecov <- read_delim("idx_meta_genomecov_PlatesAB_20180211.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
```
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesAB_20180211.txt")
```
