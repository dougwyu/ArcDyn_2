...
idxstatsgenomecovfolder <- paste0("minimap2_all_outputs_PlatesAB_", samtoolsfilter)  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups
...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_20180214_F2308_f0x2_q60.RDS", compress = TRUE)
# genomecoverages_summ <- readRDS("genomecoverages_summ_20180214_F2308_f0x2_q60.RDS")
...
sample_names <- sum_idx_meta_genomecov %>% dplyr::filter(elaterid_mordellid_sum < 20000000) %>% dplyr::select(Full_name_of_the_sample)
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesAB_20180214.txt") # so if i need to read in a file during debuggging, here it is
# used for debugging, in case i screw up the dataset while writing code
# idx_meta_genomecov <- read_delim("idx_meta_genomecov_PlatesAB_20180214.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesAB_20180214.txt")
...
# uncomment to save table
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_coefvarmin_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_coefvarmin_wide_PlatesAB_20180214.txt")
```
