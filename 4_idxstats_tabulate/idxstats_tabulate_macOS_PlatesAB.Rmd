...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_20180227_F2308_q48.RDS", compress = TRUE)
# genomecoverages_summ <- readRDS("genomecoverages_summ_20180227_F2308_q48.RDS")
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesAB_20180227.txt") # so if i need to read in a file during debuggging, here it is
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesAB_20180227.txt")
...
# uncomment to save table
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_coefvarmin_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_coefvarmin_wide_PlatesAB_20180227.txt")
```
