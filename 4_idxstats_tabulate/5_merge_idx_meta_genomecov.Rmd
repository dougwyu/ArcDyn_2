...
outputfolder <- "AB_outputs_20181111_F2308_f0x2_q48_minimap2"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesAB_20181111.txt"
...
outputfolder <- "A2B2_outputs_20181111_F2308_f0x2_q48_minimap2"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesA2B2_20181111.txt"
...
outputfolder <- "EF_outputs_20181111_F2308_f0x2_q48_minimap2"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesEF_20181111.txt"
...
outputfolder <- "GH_outputs_20181111_F2308_f0x2_q48_minimap2"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesGH_20181111.txt"
...
# confirm 349 mitogenomes
idx_meta_genomecov_ABA2B2EFGH %>% distinct(mitogenome) %>% count()  # 349: number of distinct values of mitogenome (308 mitogenomes + 41 COI_CytB - the 3 COI spikes = 349)
...
# write_tsv(idx_meta_genomecov_ABA2B2EFGH, "idx_meta_genomecov_ABA2B2EFGH_minimap2_20181111.txt")
# # 
# # # # idx_meta-genomecov wide table for visualisation:  308 rows, 707 columns
# write_tsv(idx_meta_genomecov_ABA2B2EFGH_wide, "idx_meta_genomecov_ABA2B2EFGH_wide_minimap2_20181111.txt")
# # 
# # # # idx_meta-genomecov wide table for visualisation:  148 rows, 707 columns
# write_tsv(idx_meta_genomecov_ABA2B2EFGH_wide_pctcovermin, "idx_meta_genomecov_ABA2B2EFGH_wide_pctcovermin_minimap2_20181111.txt")
```
