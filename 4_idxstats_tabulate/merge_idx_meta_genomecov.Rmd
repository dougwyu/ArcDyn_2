...
idx_meta_genomecov_ABA2B2EFGH_wide_pctcovermin <- idx_meta_genomecov_ABA2B2EFGH %>% dplyr::filter(pct_coverage > 0.1) %>% dplyr::select(DateTrapEIRUN, mitogenome, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(DateTrapEIRUN) %>% tidyr::spread(DateTrapEIRUN, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(mitogenome)

```


```{r write tables, eval=FALSE}
# idx_meta-genomecov long table for Otso, 216832 rows, 37 columns
...
# 
# # idx_meta-genomecov wide table for visualisation:  308 rows, 705 columns
# write_tsv(idx_meta_genomecov_ABA2B2EFGH_wide, "idx_meta_genomecov_ABA2B2EFGH_wide_minimap2_20180527.txt")
# #
# # idx_meta-genomecov wide table for visualisation:  126 rows, 678 columns
...
# idx_meta_genomecov <- read_tsv("idx_meta_genomecov_ABA2B2EFGH_20180227.txt")
