...
outputfolder <- "AB_outputs_20180220_F2308_q48"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesAB_20180220.txt"
...
outputfolder <- "A2B2_outputs_20180220_F2308_q48"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesA2B2_20180220.txt"
...
outputfolder <- "EF_outputs_20180220_F2308_q48"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesEF_20180220.txt"
...
outputfolder <- "GH_outputs_20180220_F2308_q48"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesGH_20180220.txt"
...
# Make wide table for visualisation (left to right should follow temporal order (DateTrapEIRUN))
idx_meta_genomecov_AB_wide <- idx_meta_genomecov_AB %>% dplyr::select(DateTrapEIRUN, mitogenome, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(DateTrapEIRUN) %>% tidyr::spread(DateTrapEIRUN, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(mitogenome)

# idx_meta-genomecov wide table for visualisation:  157 rows, 702 columns
# write_tsv(idx_meta_genomecov_AB_wide, "idx_meta_genomecov_AB_wide_20180220.txt")
```
...
# write_tsv(idx_meta_genomecov_ABA2B2EFGH, "idx_meta_genomecov_ABA2B2EFGH_20180220.txt")

# idx_meta-genomecov wide table for visualisation:  157 rows, 702 columns
# write_tsv(idx_meta_genomecov_ABA2B2EFGH_wide, "idx_meta_genomecov_ABA2B2EFGH_wide_20180220.txt")
```
...
```{r summary tables}
setwd("~/Dropbox/Working_docs/Roslin_Greenland/2017/bulk_samples/PlatesABA2B2EFGH")
# idx_meta_genomecov <- read_tsv("idx_meta_genomecov_ABA2B2EFGH_20180220.txt")
...
sum_idx_meta_genomecov <- idx_meta_genomecov %>% 
    ...
    arrange(Date, Trap)
# write_tsv(sum_idx_meta_genomecov, "idx_meta_genomecov_ABA2B2EFGH_summ_20180221.txt")
...
sum_idx_meta_genomecov2 <- idx_meta_genomecov %>% 
    ...
    arrange(Date, Trap)
# write_tsv(sum_idx_meta_genomecov2, "idx_meta_genomecov_ABA2B2EFGH_summ2_20180221.txt")
...
```{r}
sum_idx_meta_genomecovAB <- sum_idx_meta_genomecov %>% dplyr::filter(EI_RUN == "idx_meta_genomecov_AB")

p <- ggplot(sum_idx_meta_genomecovAB, aes(x = Date, y = species_obs_mapped_reads, group = Trap))
