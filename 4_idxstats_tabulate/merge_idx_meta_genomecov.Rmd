...
outputfolder <- "AB_outputs_20180214_F2308_f0x2_q60"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesAB_20180214.txt"
...
outputfolder <- "A2B2_outputs_20180214_F2308_f0x2_q60"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesA2B2_20180214.txt"
...
outputfolder <- "EF_outputs_20180214_F2308_f0x2_q60"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesEF_20180214.txt"
...
outputfolder <- "GH_outputs_20180214_F2308_f0x2_q60"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesGH_20180214.txt"
...
# write_tsv(idx_meta_genomecov_ABA2B2EFGH, "idx_meta_genomecov_ABA2B2EFGH_20180214.txt")

# idx_meta-genomecov wide table for visualisation:  157 rows, 702 columns
# write_tsv(idx_meta_genomecov_ABA2B2EFGH_wide, "idx_meta_genomecov_ABA2B2EFGH_wide_20180214.txt")
```
...
# idx_meta-genomecov wide table for visualisation:  157 rows, 702 columns
write_tsv(idx_meta_genomecov_AB_wide, "idx_meta_genomecov_AB_wide_20180214.txt")
