...
idx_meta_genomecov_AB <- read_delim("idx_meta_genomecov_PlatesAB_20180210.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
idx_meta_genomecov_A2B2 <- read_delim("idx_meta_genomecov_PlatesA2B2_20180210.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
idx_meta_genomecov_EF <- read_delim("idx_meta_genomecov_PlatesEF_20180210.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
idx_meta_genomecov_GH <- read_delim("idx_meta_genomecov_PlatesGH_20180210.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
write_tsv(idx_meta_genomecov_ABA2B2EFGH, "idx_meta_genomecov_ABA2B2EFGH_20180210.txt")

# idx_meta-genomecov wide table for visualisation:  157 rows, 702 columns
write_tsv(idx_meta_genomecov_ABA2B2EFGH_wide, "idx_meta_genomecov_ABA2B2EFGH_wide_20180210.txt")
```
