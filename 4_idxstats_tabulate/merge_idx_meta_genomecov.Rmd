...
outputfolder <- "AB_outputs_20180227_F2308_f0x2_q48"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesAB_20180227.txt"
...
outputfolder <- "A2B2_outputs_20180227_F2308_f0x2_q48"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesA2B2_20180227.txt"
...
outputfolder <- "EF_outputs_20180227_F2308_f0x2_q48"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesEF_20180227.txt"
...
outputfolder <- "GH_outputs_20180227_F2308_f0x2_q48"
idxmetagenomcovfile <- "idx_meta_genomecov_PlatesGH_20180227.txt"
...
# confirm 307 mitogenomes
idx_meta_genomecov_ABA2B2EFGH %>% distinct(mitogenome) %>% count()  # 307: number of distinct values of mitogenome (310 total mitogenomes - the 3 COI spikes = 307)
...
idx_meta_genomecov_ABA2B2EFGH_wide_coefvar2max <- idx_meta_genomecov_ABA2B2EFGH %>% dplyr::filter(coefvar < 2) %>% dplyr::select(DateTrapEIRUN, mitogenome, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(DateTrapEIRUN) %>% tidyr::spread(DateTrapEIRUN, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(mitogenome)
...
# write_tsv(idx_meta_genomecov_ABA2B2EFGH, "idx_meta_genomecov_ABA2B2EFGH_20180227.txt")
# 
# # idx_meta-genomecov wide table for visualisation:  307 rows, 678 columns
# write_tsv(idx_meta_genomecov_ABA2B2EFGH_wide, "idx_meta_genomecov_ABA2B2EFGH_wide_20180227.txt")
# #
# # idx_meta-genomecov wide table for visualisation:  126 rows, 678 columns
# write_tsv(idx_meta_genomecov_ABA2B2EFGH_wide_coefvar2max, "idx_meta_genomecov_ABA2B2EFGH_wide_coefvarmax2_20180227.txt")
#
```
...
# Make wide table for visualisation (left to right should follow temporal order (DateTrapEIRUN))
idx_meta_genomecov_AB_wide_coefvar2max <- idx_meta_genomecov_AB %>% dplyr::filter(coefvar < 2) %>% dplyr::select(DateTrapEIRUN, mitogenome, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(DateTrapEIRUN) %>% tidyr::spread(DateTrapEIRUN, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(mitogenome)

# idx_meta-genomecov wide table for visualisation:  157 rows, 702 columns
# write_tsv(idx_meta_genomecov_AB_wide_coefvar2max, "idx_meta_genomecov_AB_wide_coefvarmax2_20180227.txt")
```
...
sum_idx_meta_genomecov <- idx_meta_genomecov %>% 
    ...
    arrange(Date, Trap)
# write_tsv(sum_idx_meta_genomecov, "idx_meta_genomecov_ABA2B2EFGH_summ_20180227.txt")
...
sum_idx_meta_genomecov2 <- idx_meta_genomecov %>% 
    ...
    arrange(Date, Trap)
# write_tsv(sum_idx_meta_genomecov2, "idx_meta_genomecov_ABA2B2EFGH_summ2_20180227.txt")
