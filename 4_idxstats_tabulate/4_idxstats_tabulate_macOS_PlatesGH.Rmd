...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_PlatesGH_minimap2_20180527.RDS", compress = TRUE)
...
sample_names <- sum_idx_meta_genomecov %>% dplyr::filter(COI_spike_sum < 371896) %>% dplyr::select(Short_name_of_the_sample)
samples_to_remove <- sample_names %>% dplyr::pull(Short_name_of_the_sample) # pull out a single variable
samples_to_remove # 6 samples to remove including ME50_1
idx_meta_genomecov <- idx_meta_genomecov %>% filter(!Short_name_of_the_sample %in% samples_to_remove) # 29045 obs

# sanity check:  184 samples, which is correct since i removed 6 samples
...
# write_tsv(mocks_idx_meta_genomecov, "mocks_idx_meta_genomecov_PlatesGH_20180527.txt") # so if i need to read in a file during debuggging, here it is
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesGH_20180527.txt") # so if i need to read in a file during debuggging, here it is.  This is the file for HMSC analysis.
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesGH_20180527.txt")
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide_PlatesGH_20180527.txt")
...
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide, "mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide_PlatesGH_20180527.txt")
# write_tsv(mocks_idx_meta_genomecov_pctcov_wide, "mocks_idx_meta_genomecov_mocks_idx_meta_genomecov_pctcov_wide_wide_PlatesGH_20180527.txt")
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_wide, "mocks_idx_meta_genomecov_mapped_reads_wide_PlatesGH_20180527.txt")
```
