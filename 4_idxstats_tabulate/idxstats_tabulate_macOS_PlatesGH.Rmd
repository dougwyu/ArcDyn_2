...
idx_mitogenome_table <- idx %>% group_by(well) %>% distinct(mitogenome) %>% count() %>% arrange(desc(n)); View(idx_mitogenome_table) # should be 160
...
# genomecoverages_summ <- readRDS("genomecoverages_summ_PlatesGH_20180214.RDS")
# 
