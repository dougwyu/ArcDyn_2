...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_PlatesGH_20180211.RDS", compress = TRUE)
# genomecoverages_summ <- readRDS("genomecoverages_summ_PlatesGH_20180211.RDS")
# 
...
# [13] "samtools_filter"            "pathname"                   "Full_name_of_the_sample"    "Date"                      
...
# create variable from Year, Week, and Trap(ABC) # commented out because i have month and date information now
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesGH_20180211.txt") # so if i need to read in a file during debuggging, here it is
# used for debugging, in case i screw up the dataset while writing code
# idx_meta_genomecov <- read_delim("idx_meta_genomecov_PlatesGH_20180211.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
```
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesGH_20180211.txt")
# 
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_wide, "mocks_idx_meta_genomecov_mapped_reads_wide_PlatesGH_20180211.txt")
# 
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide, "mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide_PlatesGH_20180211.txt")
```
