...
# calculate sum of the two COI spike reads for each row
...
idx_meta_genomcov_mapped_reads_COI_lysis_corr_wide <- idx_meta_genomecov %>% dplyr::select(DateTrap, mitogenome, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(DateTrap) %>% tidyr::spread(DateTrap, mapped_reads_COI_lysis_corr) %>% dplyr::arrange(mitogenome)

write_tsv(idx_meta_genomcov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomcov_mapped_reads_COI_lysis_corr_wide.txt")
```
