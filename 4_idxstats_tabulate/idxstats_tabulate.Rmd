...
write_tsv(idx_meta_genomcov_wide, "idx_meta_genomecov_wide.txt")
```

Do the lysis buffer and COI_spike corrections here
```{r}
...
7. DONE minimap2/samtools for platesGH
8. DONE minimap2/samtools for platesA2B2
...
9.1 remove orig fastq.gz files from A2B2 and GH when i'm done mapping`
