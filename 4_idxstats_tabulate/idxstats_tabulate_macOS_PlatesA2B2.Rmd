...
idxstatsgenomecovfolder <- paste0("bwa_outputs_PlatesA2B2_", samtoolsfilter, "_", samtoolsqual, "_minimap2_20180527")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups
...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_PlatesA2B2_20180526.RDS", compress = TRUE)
