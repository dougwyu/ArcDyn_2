...
# use this version for bwa
# bwa_outputs_PlatesGH_F2308_f0x2_q48_bwa_20180526
# idxstatsgenomecovfolder <- paste0("bwa_outputs_PlatesA2B2_", samtoolsfilter, "_", samtoolsqual, "_bwa_20180526")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups

# use this version for minimap2
# outputs_PlatesA2B2_F2308_f0x2_q48_minimap2_20180527
idxstatsgenomecovfolder <- paste0("outputs_PlatesA2B2_", samtoolsfilter, "_", samtoolsqual, "_minimap2_20180527")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups

# use this version for COI_barcodes mapping
idxstatsgenomecovfolder <- paste0("outputs_PlatesA2B2_", samtoolsfilter, "_", samtoolsqual, "_COIBarcodesOnly_minimap2_outputs_20180727")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups
# outputs_PlatesA2B2_F2308_f0x2_q48_COIBarcodesOnly_minimap2_outputs_20180727
...
idx_mitogenome_table <- idx %>% group_by(well) %>% distinct(mitogenome) %>% count() %>% arrange(desc(n)); View(idx_mitogenome_table) # all columns should be 311
...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_PlatesA2B2_20180527.RDS", compress = TRUE)
# genomecoverages_summ <- readRDS("A2B2_outputs_20180526_F2308_f0x2_q48_BWA/genomecoverages_summ_PlatesA2B2_20180526.RDS")
...
sample_names <- sum_idx_meta_genomecov %>% dplyr::filter(COI_spike_sum < 282832) %>% dplyr::select(Full_name_of_the_sample)
...
# should be 2, and it's 1.84, sd = 0.26
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesA2B2_20180527.txt") # so if i need to read in a file during debuggging, here it is
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesA2B2_20180527.txt")
...
# uncomment to save table
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide_PlatesA2B2_20180527.txt")
```
