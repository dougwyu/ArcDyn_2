...
# outputs_PlatesAB_F2308_f0x2_q48_minimap2_outputs_20181111
idxstatsgenomecovfolder <- paste0("outputs_PlatesAB_", samtoolsfilter, "_", samtoolsqual, "_minimap2_outputs_20181111")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups
...
idx_mitogenome_table <- idx %>% group_by(well) %>% distinct(mitogenome) %>% count() %>% arrange(desc(n)); View(idx_mitogenome_table) # should be 352 in all rows (308 mitogenomes + 41 COI+cytB + 3 COI_spike)
...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_PlatesAB_minimap2_20181111.RDS", compress = TRUE)
# genomecoverages_summ <- readRDS("genomecoverages_summ_PlatesAB_minimap2_20181111.RDS")
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesAB_20181111.txt") # so if i need to read in a file during debuggging, here it is. This is the file for HMSC analysis.
# used for debugging, in case i screw up the dataset while writing code
# idx_meta_genomecov <- read_delim("idx_meta_genomecov_PlatesAB_20181111.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesAB_20181111.txt")
...
# uncomment to save table
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide_PlatesAB_20181111.txt")
```
