...
idxstatsgenomecovfolder <- paste0("outputs_PlatesAB_", samtoolsfilter, "_", samtoolsqual, "_COIBarcodesOnly_minimap2_outputs_20180727")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups
# outputs_PlatesAB_F2308_f0x2_q48_COIBarcodesOnly_minimap2_outputs_20180727
...
sample_names <- sum_idx_meta_genomecov %>% dplyr::filter(elaterid_mordellid_sum < 233300) %>% dplyr::select(Full_name_of_the_sample)
