...
# idxstatsgenomecovfolder <- paste0("bwa_outputs_PlatesEF_", samtoolsfilter, "_", samtoolsqual, "_bwa_20180526")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups

# use this version for minimap2 mapping
# outputs_PlatesEF_F2308_f0x2_q48_minimap2_20180527
idxstatsgenomecovfolder <- paste0("outputs_PlatesEF_", samtoolsfilter, "_", samtoolsqual, "_minimap2_20180527")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups

# use this version for COI_barcodes mapping
idxstatsgenomecovfolder <- paste0("outputs_PlatesEF_", samtoolsfilter, "_", samtoolsqual, "_COIBarcodesOnly_minimap2_outputs_20180727")  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups
# outputs_PlatesEF_F2308_f0x2_q48_COIBarcodesOnly_minimap2_outputs_20180727
...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_PlatesEF_20180527.RDS", compress = TRUE)
...
idx_meta_genomecov$COI_Species <- if_else(grepl("_COI", idx_meta_genomecov$mitogenome), "COI_Spike", "ArcDyn_Species")
...
COI_spike_reads_wide <- COI_spike_reads_wide %>% rename(Lepidoptera_Bombycidae_Bombyx_mori_10ng_COI="1-2_Lepidoptera_Bombycidae_Bombyx_mori_COI")

COI_spike_reads_wide <- COI_spike_reads_wide %>% rename(Coleoptera_Elateridae_40ng_COI="2-1_Coleoptera_Elateridae_COI")

COI_spike_reads_wide <- COI_spike_reads_wide %>% rename(Coleoptera_Mordellidae_20ng_COI="3-1_Coleoptera_Mordellidae_COI")
...
sample_names <- sum_idx_meta_genomecov %>% dplyr::filter(COI_spike_sum < 81200) %>% dplyr::select(Full_name_of_the_sample)
samples_to_remove <- sample_names %>% dplyr::pull(Full_name_of_the_sample) # pull out a single variable
samples_to_remove # 2 samples to remove (using q48)
...
# should be 2, and it's 2.17, sd = 0.37
...
# write_tsv(mocks_idx_meta_genomecov, "mocks_idx_meta_genomecov_PlatesEF_20180527.txt") # so if i need to read in a file during debuggging, here it is
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesEF_20180527.txt") # so if i need to read in a file during debuggging, here it is.  This is the file that we use for HMSC analysis, long format
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesEF_20180527.txt")
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_pctcovmin_wide_PlatesEF_20180527.txt")
...
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide, "mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide_PlatesEF_20180527.txt")
# # #
# write_tsv(mocks_idx_meta_genomecov_pct_coverage_wide, "mocks_idx_meta_genomecov_pct_coverage_wide_PlatesEF_20180527.txt")
# # #
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_wide, "mocks_idx_meta_genomecov_mapped_reads_wide_PlatesEF_20180527.txt")#
```
