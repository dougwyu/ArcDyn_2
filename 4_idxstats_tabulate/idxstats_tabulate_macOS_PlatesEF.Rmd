...
idxstatsgenomecovfolder <- paste0("minimap2_all_outputs_PlatesEF_", samtoolsfilter)  # this is the enclosing folder around the idxstats and genomcov files for a given set of soups
...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_PlatesEF_20180214.RDS", compress = TRUE)
# genomecoverages_summ <- readRDS("EF_outputs_20180214_F2308_f0x2_q60/genomecoverages_summ_PlatesEF_20180214.RDS")
...
# write_tsv(mocks_idx_meta_genomecov, "mocks_idx_meta_genomecov_PlatesEF_20180214.txt") # so if i need to read in a file during debuggging, here it is
# mocks_idx_meta_genomecov <- read_delim("mocks_idx_meta_genomecov_PlatesEF_20180214.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesEF_20180214.txt") # so if i need to read in a file during debuggging, here it is
# used for debugging, in case i screw up the dataset while writing code
# idx_meta_genomecov <- read_delim("idx_meta_genomecov_PlatesEF_20180214.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesEF_20180214.txt")
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_coefvarmin_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_coefvarmin_wide_PlatesEF_20180214.txt")
...
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide, "mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide_PlatesEF_20180214.txt")
# 
# write_tsv(mocks_idx_meta_genomecov_coefvar_wide, "mocks_idx_meta_genomecov_coefvar_wide_PlatesEF_20180214.txt")
# 
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_wide, "mocks_idx_meta_genomecov_mapped_reads_wide_PlatesEF_20180214.txt")#
```
