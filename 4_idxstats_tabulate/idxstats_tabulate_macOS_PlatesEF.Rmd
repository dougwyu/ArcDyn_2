...
genomecoverages_summ <- purrr::map(genomecov_files, loadFile2);  system("say Your loadfile2 function has finally finished!"); beep(sound = 3); beep(sound = 9); beep(sound = 3)
...
# saveRDS(genomecoverages_summ, "genomecoverages_summ_PlatesEF_20180210.RDS", compress = TRUE)
# genomecoverages_summ <- readRDS("genomecoverages_summ_PlatesEF_20180210.RDS")
...
# filter out samples with COI_spike_sum < 100 000 (summed over all 160 mitogenomes in the sample).  This removes 2 samples with very small numbers of COI_spike_sum
...
# write_tsv(idx_meta_genomecov, "idx_meta_genomecov_PlatesEF_20180210.txt") # so if i need to read in a file during debuggging, here it is
# used for debugging, in case i screw up the dataset while writing code
# idx_meta_genomecov <- read_delim("idx_meta_genomecov_PlatesEF_20180210.txt", delim = "\t", escape_double = FALSE, trim_ws = TRUE)
...
# write_tsv(idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide, "idx_meta_genomecov_mapped_reads_COI_lysis_corr_wide_PlatesEF_20180210.txt")
# 
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_wide, "mocks_idx_meta_genomecov_mapped_reads_wide_PlatesEF_20180210.txt")
# 
# write_tsv(mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide, "mocks_idx_meta_genomecov_mapped_reads_COI_corr_wide_PlatesEF_20180210.txt")
```
